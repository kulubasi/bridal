...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO kids(image,descri) VALUES('$img', '$desc')";
                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="users.php">Kids</a></li>
                                    ...
                                    <div class="table-responsive">
                                        <table id="example" class="table table-striped table-sm table-nowrap table-centered mb-0">
                                            ...
                                            <tbody style="text-transform: uppercase; font-size:11px;">
                                                ...
                                                $query = mysqli_query($conn, "SELECT * FROM kids");
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?= ($row['descri']); ?></td>
                                                        <td>
                                                            <a href="edit_kids.php?id=<?= $row['id'];?>" class="btn btn-warning"><i class="las la-edit "></i></a>
                                                            <a href="delete_kids.php?id=<?= $row['id']; ?>" class="btn btn-danger"><i class="las la-trash "></i>
                                                            </a>
                                                        </td>
                                                    </tr>
                                                <?php
