...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO men(image,descri) VALUES('$img', '$desc')";
                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="users.php">Gentlemen</a></li>
                                    <li class="breadcrumb-item active">Gentlemen</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <tbody style="text-transform: uppercase; font-size:11px;">
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?= ($row['descri']); ?></td>
                                                        <td>
                                                            <a href="edit_men.php?id=<?= $row['id'];?>" class="btn btn-warning"><i class="las la-edit "></i></a>
                                                            <a href="delete_men.php?id=<?= $row['id']; ?>" class="btn btn-danger"><i class="las la-trash "></i>
                                                            </a>
                                                        </td>
                                                    </tr>
                                                <?php
